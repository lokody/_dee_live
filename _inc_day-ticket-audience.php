	<div class="block reg-block">
		...
		<div class="content-container">
			<h2>DAY TICKET FOR AUDIENCE</h2>

			<div class="regform-container">
				<form id="regform" method="post" action="">
					<input type="hidden" name="user-type" value="audience">
				...
				<div class="form-group">
					...
					<div class="sum-container">
						<div class="article-container ticket" data-price="10">
							<div class="text"><span class="sum">0</span> × Day Ticket - Audience</div>
							<div class="price">€0</div>
						</div>
						<div class="article-container dinner" data-price="40">
							<div class="text"><span class="sum">0</span> × Dinner Ticket - 26 May - Audience</div>
							<div class="price">€0</div>
						</div>
